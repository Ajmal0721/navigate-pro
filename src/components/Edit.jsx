...
function Edit() {
    ...
    return (
        <>
            <div className="container mt-5" style={{backgroundColor:blur}}>
                ...
                <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        ...
                        <input type="checkbox" name="hobby" value="Gaming" checked={hobby.includes('Gaming')} onChange={handleInput} /> Gaming
                        <input type="checkbox" name="hobby" value="Coding" checked={hobby.includes('Coding')} onChange={handleInput} /> Coding
                        <input type="checkbox" name="hobby" value="Reading" checked={hobby.includes('Reading')} onChange={handleInput} /> Reading
                    </div>
                    <div className="form-group">
                        <label>City</label>
